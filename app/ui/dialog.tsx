      ...
      {open && (
        <DialogHeadless open={open} onClose={onClose} className="relative z-50">
          <motion.div
            ...
            exit={{ opacity: 0 }}
          />
          <div className="fixed inset-0 flex w-screen items-end justify-center p-4 min-[480px]:p-8">
            <DialogPanel
              className="border border-primary-200 bg-white p-6 min-[480px]:p-8 rounded-md shadow-lg font-inter"
              as={motion.div}
