...
function NavLink({
  ...
  return (
    <Link
      href={href}
      className={`text-center rounded-full font-semibold px-4 py-2.5 text-sm hover:bg-primary-200 hover:text-primary-800/90 transition duration-150 ease-in-out ${
