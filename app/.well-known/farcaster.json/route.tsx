...
function getAccountAssociation(domain: string | null): Manifest.AccountAssociation {
  ...
  if (domain?.toLowerCase() === "framedl.com") {
    return {
      header:
        "eyJmaWQiOjExMTI0LCJ0eXBlIjoiYXV0aCIsImtleSI6IjB4YzI5MjZBMzlkMGQ4OGQ0YzFCMjI3RGVCOTMzMDIyRjE0OTJlODE4QyJ9",
      payload: "eyJkb21haW4iOiJmcmFtZWRsLmNvbSJ9",
      signature:
        "/tMoU93GtKytjHrgmLd4lkPnjVxLw0Y0i3OYOj/qwioYmRi/UpfTk2c724in1XTIcLXrsDGyzEYwrc6BXlPV8xw=",
    };
  }
  return {
    header:
...
export async function GET(req: NextRequest) {
  ...
  const accountAssociation = getAccountAssociation(domain);
